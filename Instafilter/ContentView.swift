...
struct ContentView: View {
	...
	var body: some View {
		...
		return NavigationView {
			VStack {
				...
				.navigationBarTitle("Instafilter", displayMode: .inline)
	...
	func applyProcessing() {
		...
		guard let outputImge = currentFilter.outputImage else { return }
		
		if let cgimg = context.createCGImage(outputImge, from: outputImge.extent) {
